...
disrupter1_mass = 9e27
disrupter2_mass = 9e27
...
disrupter_1 = sphere(pos=vector(7*AU,-20*AU,0),velocity=vector(-disrupter1_vel/15,disrupter1_vel,0),
             mass=disrupter1_mass, radius=0.05*AU, color=color.purple)
disrupter_2 = sphere(pos=vector(-7*AU,20*AU,0),velocity=vector(disrupter2_vel/15,-disrupter2_vel,0),
             mass=disrupter2_mass, radius=0.05*AU, color=color.purple)

#Create a list of objects making up our solar system 
#and add attributes for their accelaration and orbits

bodies = [sun, earth, mars, jupiter, saturn, disrupter_1, disrupter_2] 
