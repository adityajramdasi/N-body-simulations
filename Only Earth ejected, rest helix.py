...
massive  = sphere(pos=vector( -15*AU,-12*AU,-13*AU),velocity=vector(massive_vel,massive_vel,massive_vel),
             mass=massive_mass, radius=0.2*AU, color=color.purple)


#Create a list of objects making up our solar system 
#and add attributes for their accelaration and orbits

bodies = [sun, earth, mars, jupiter, saturn, massive]
