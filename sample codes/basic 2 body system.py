...
earth      = sphere(pos= vector(AU, 0, 0), velocity = vector(0,earth_vel,0),
             mass = earth_mass, radius = 0.01*AU, color = color.blue)
# Limitation 1
#the radius of sun and earth are NOT their true radius. 
#these are the radius of the spherical object that will be drawn on the computer screen.
...
#start leap-frog
while True:
    rate(50)  #50 time steps in a second is an optimum value
    for b in bodies:
